...
# Checkout and "build" Kataspace/Interactive Room
cd ${DIR} && \
git clone git://github.com/GillesAnna/InteractiveRoom.git InteractiveRoom.git && \
cd InteractiveRoom.git && \
make || \
bail "Couldn't build InteractiveRoom."
